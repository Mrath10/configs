...
static const char *const autostart[] = {
    "wbg", "/home/mayv/Pictures/Wallpapers/dragon.jpg", NULL, "waybar", NULL,
    //"sh","-c","dbus-update-activation-envrionment", "--systemd WAYLAND_DISPLAY
    //XDG_CURRENT_DESKTOP",NULL,
    "sh", "/home/mayv/.config/scripts/poststart.sh", NULL, NULL /*terminate*/
};
...
#define VOLUP "~/.config/scripts/up-volume.sh"
#define VOLDOWN "~/.config/scripts/down-volume.sh"
...
static const Key keys[] = {
    ...
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn, SHCMD(VOLUP)},
    {0, XKB_KEY_XF86AudioLowerVolume, spawn, SHCMD(VOLDOWN)},
